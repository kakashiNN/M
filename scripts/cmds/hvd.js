...
module.exports = {
  config: {
    ...
    countDown: 60,
    role: 0,
    shortDescription: "get hentai video (VIP only)",
    longDescription: "it will send hentai video (VIP users only)",
    category: "𝟭𝟴+🌚",
    guide: "{p}{n}hvdo",
  },
  ...
  langs: {
    en: {
      notVip:
        "❌ | You are not a VIP user. Type !vip to see how to get VIP access.",
    },
  },
  ...
  onStart: async function ({ api, event, message }) {
    ...
    const loadingMessage = await message.reply({
      body: "- please wait! up to 5min for bentai video 🌚👌",
    });
